...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            ...
            'electron-remote-win32-x64': {
                cwd: 'node_modules/@electron/remote',
                src: '**/*',
                dest: 'tmp/desktop/KeeWeb-win32-x64/resources/node_modules/@electron/remote',
                expand: true
            },
            'electron-remote-win32-ia32': {
                cwd: 'node_modules/@electron/remote',
                src: '**/*',
                dest: 'tmp/desktop/KeeWeb-win32-ia32/resources/node_modules/@electron/remote',
                expand: true
            },
            'electron-remote-win32-arm64': {
                cwd: 'node_modules/@electron/remote',
                src: '**/*',
                dest: 'tmp/desktop/KeeWeb-win32-arm64/resources/node_modules/@electron/remote',
                expand: true
            },
            'electron-remote-darwin-x64': {
                cwd: 'node_modules/@electron/remote',
                src: '**/*',
                dest:
                    'tmp/desktop/KeeWeb-darwin-x64/KeeWeb.app/Contents/Resources/app.asar.unpacked/node_modules/@electron/remote',
                expand: true
            },
            'electron-remote-darwin-arm64': {
                cwd: 'node_modules/@electron/remote',
                src: '**/*',
                dest:
                    'tmp/desktop/KeeWeb-darwin-arm64/KeeWeb.app/Contents/Resources/app.asar.unpacked/node_modules/@electron/remote',
                expand: true
            },
            'electron-remote-linux-x64': {
                cwd: 'node_modules/@electron/remote',
                src: '**/*',
                dest: 'tmp/desktop/keeweb-linux-x64/resources/node_modules/@electron/remote',
                expand: true
            }
        },
        eslint: {
