...
public partial class MainViewViewModel : ViewModelBase
{
    ...
    private void OnNavigation(MainViewViewModel vm, string s)
    {
        Content = s switch
        {
            MenuKeys.MenuKeyAllItems => new NavMenuDemoViewModel(),
            MenuKeys.MenuKeyRecycleBin => new NavMenuDemoViewModel(),
            MenuKeys.MenuKeyAuditDuplicate => new NavMenuDemoViewModel(),
            MenuKeys.MenuKeyAuditWeak => new NavMenuDemoViewModel(),
